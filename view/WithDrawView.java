...
public class WithDrawView extends javax.swing.JPanel {
     ...
     */
    public WithDrawView(ApplicationProperty app) {
        this.app = app;
        initComponents();
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(inputAmount, javax.swing.GroupLayout.PREFERRED_SIZE, 272, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnTakeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTakeActionPerformed
        ...
        try {
            amountWithdraw = Integer.parseInt(inputAmount.getText());
        ...
        if (userType == 0) {
            if (app.store.getCustomer(userId).getTabungan().
             ...
             if (app.store.getSeller(userId).getTabungan().
                    ambilUang(amountWithdraw)) {
                JOptionPane.showMessageDialog(this, "Withdraw"
                        + " Success!");
